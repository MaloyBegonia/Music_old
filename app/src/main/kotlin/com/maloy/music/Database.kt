...
@Dao
interface Database {
    companion object : com.maloy.music.Database by com.maloy.music.DatabaseInitializer.Companion.Instance.database
...
@androidx.room.Database(
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 3, to = 4, spec = com.maloy.music.DatabaseInitializer.From3To4Migration::class),
        AutoMigration(from = 4, to = 5),
        AutoMigration(from = 5, to = 6),
        AutoMigration(from = 6, to = 7),
        AutoMigration(from = 7, to = 8, spec = com.maloy.music.DatabaseInitializer.From7To8Migration::class),
        AutoMigration(from = 9, to = 10),
        AutoMigration(from = 11, to = 12, spec = com.maloy.music.DatabaseInitializer.From11To12Migration::class),
        ...
        AutoMigration(from = 20, to = 21, spec = com.maloy.music.DatabaseInitializer.From20To21Migration::class),
        AutoMigration(from = 21, to = 22, spec = com.maloy.music.DatabaseInitializer.From21To22Migration::class),
    ],
)
@TypeConverters(com.maloy.music.Converters::class)
abstract class DatabaseInitializer protected constructor() : RoomDatabase() {
    abstract val database: com.maloy.music.Database

    companion object {
        lateinit var Instance: com.maloy.music.DatabaseInitializer

        context(Context)
        operator fun invoke() {
            if (!com.maloy.music.DatabaseInitializer.Companion::Instance.isInitialized) {
                com.maloy.music.DatabaseInitializer.Companion.Instance = Room
                    .databaseBuilder(this@Context, com.maloy.music.DatabaseInitializer::class.java, "data.db")
                    .addMigrations(
                        com.maloy.music.DatabaseInitializer.From8To9Migration(),
                        com.maloy.music.DatabaseInitializer.From10To11Migration(),
                        com.maloy.music.DatabaseInitializer.From14To15Migration(),
                        com.maloy.music.DatabaseInitializer.From22To23Migration()
                    )
                    .build()
            }
        }
...
val com.maloy.music.Database.internal: RoomDatabase
    get() = com.maloy.music.DatabaseInitializer.Companion.Instance

fun query(block: () -> Unit) = com.maloy.music.DatabaseInitializer.Companion.Instance.queryExecutor.execute(block)

fun transaction(block: () -> Unit) = with(com.maloy.music.DatabaseInitializer.Companion.Instance) {
