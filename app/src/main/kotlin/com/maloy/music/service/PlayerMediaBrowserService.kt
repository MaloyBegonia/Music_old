        ...
        runBlocking(Dispatchers.IO) {
            result.sendResult(
                when (parentId) {
                    ...
                    MediaId.songs -> com.maloy.music.Database
                        .songsByPlayTimeDesc()
                        .first()
                        .take(30)
                        .also { lastSongs = it }
                    ...
                    MediaId.playlists -> com.maloy.music.Database
                    ...
                    MediaId.albums -> com.maloy.music.Database
                        .albumsByRowIdDesc()
                        .first()
                        .map { it.asBrowserMediaItem }
                        .toMutableList()
        ...
        override fun onPlayFromMediaId(mediaId: String?, extras: Bundle?) {
            ...
            coroutineScope.launch {
                val mediaItems = when (data.getOrNull(0)) {
                    ...
                    MediaId.favorites -> com.maloy.music.Database
                        .favorites()
                        .first()
                        .shuffled()

                    MediaId.offline -> com.maloy.music.Database
                    ...
                    MediaId.playlists -> data
                        .getOrNull(1)
                        ?.toLongOrNull()
                        ?.let(com.maloy.music.Database::playlistWithSongs)
                        ?.first()
                        ?.songs
                        ?.shuffled()
                    ...
                    MediaId.albums -> data
                        .getOrNull(1)
                        ?.let(com.maloy.music.Database::albumSongs)
                        ?.first()
