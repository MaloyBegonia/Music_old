...
*/
    ...
    private fun maybeSavePlayerQueue() {
        ...
        mediaItems.mapIndexed { index, mediaItem ->
            ...
            com.maloy.music.query {
                com.maloy.music.Database.clearQueue()
                com.maloy.music.Database.insert(queuedMediaItems)
            }
        }
    }
    ...
    private fun maybeRestorePlayerQueue() {
        ...
        com.maloy.music.query {
            val queuedSong = com.maloy.music.Database.queue()
            com.maloy.music.Database.clearQueue()
    ...
    private fun maybeNormalizeVolume() {
        ...
        player.currentMediaItem?.mediaId?.let { songId ->
            ...
            volumeNormalizationJob = coroutineScope.launch(Dispatchers.Main) {
                com.maloy.music.Database.loudnessDb(songId).cancellable().collectLatest { loudnessDb ->
                    try {
                                    ...
                                    if (mediaItem?.mediaMetadata?.extras?.getString("durationText") == null) {
                                        format.approxDurationMs?.div(1000)
                                            ...
                                            ?.let { durationText ->
                                                ...
                                                com.maloy.music.Database.updateDurationText(videoId, durationText)
                                            }
                                    }

                                    com.maloy.music.query {
                                        mediaItem?.let(com.maloy.music.Database::insert)
